            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <a href="<?= isset($customer) ? url_to('customer.invoice.list', $customer->id) : url_to('invoice.list') ?>" class="btn btn-info">
                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <p>Are you sure want to delete invoice <strong><?= $invoice->invoice_number; ?></strong> of <?= $invoice->customer_name; ?>?</p>
