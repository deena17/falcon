        ...
        <div class="card-body">
            <?php if(!empty($invoices)): ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <p>Sales Agreement </p>
                        <a href="<?= url_to('customer.invoice.edit', $customer->id, $i->id); ?>" class="btn btn-primary"><i
                                class="fa fa-pencil-alt"></i> Edit</a>
                        <a href="<?= url_to('customer.invoice.delete', $customer->id, $i->id); ?>" class="btn btn-danger"><i
