            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <a href="<?= url_to('customer.salesorder.list', $customer->id) ?>" class="btn btn-info">
                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <p>Are you sure want to delete sales order <strong><?= $order->order_number; ?></strong> of <?= $customer->customer_name; ?>?</p>
