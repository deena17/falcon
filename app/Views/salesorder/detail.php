...
<section class="content">
    <div class="card">
        ...
        <div class="card-header py-2">
            ...
            <a href="<?= isset($customer) ? url_to('customer.salesorder.list', $customer->id) : url_to('order.list'); ?>" class="btn btn-info float-right">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="customer-name" 
                            name="customer_name" 
                            value="<?= set_value('customer_name', isset($customer) ? $customer->customer_name : $order->customer_name); ?>" 
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="contact-number" 
                            name="contact_number" 
                            value="<?= set_value('contact_number', isset($customer) ? $customer->contact_number : $order->contact_number); ?>" 
                            <?php if(isset($customer)) echo "readonly" ?>  
                        />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            value="<?= set_value('contact_landline', isset($customer) ? $customer->contact_landline : $order->contact_landline); ?>" 
                            <?php if(isset($customer)) echo "readonly" ?> 
                        />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="street" 
                            name="street" 
                            value="<?= set_value('street', isset($customer) ? $customer->contact_street : $order->street); ?>" 
                            <?php if(isset($customer)) echo "readonly" ?> 
                        />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="city" 
                            name="city" 
                            value="<?= set_value('city', isset($customer) ? $customer->contact_city : $order->city); ?>" 
                            <?php if(isset($customer)) echo "readonly" ?>  
                        />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="district" 
                            name="district" 
                            value="<?= set_value('district', isset($customer) ? $customer->contact_district : $order->district); ?>" 
                            <?php if(isset($customer)) echo "readonly" ?>  
                        />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="state" 
                            name="state" 
                            value="<?= set_value('state', isset($customer) ? $customer->contact_state : $order->state); ?>" 
                            <?php if(isset($customer)) echo "readonly" ?>  
                        />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="pincode" 
                            name="pincode" 
                            value="<?= set_value('pincode', isset($customer) ? $customer->contact_pincode : $order->pincode); ?>" 
                            <?php if(isset($customer)) echo "readonly" ?> 
                        />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="area" 
                            name="area" 
                            value="<?= set_Value('area', isset($customer) ? $customer->contact_area : $order->area); ?>" 
                            <?php if(isset($customer)) echo "readonly" ?> 
                        />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="remarks" id="remarks" cols="30" rows="1" class="form-control"><?= $order->remarks; ?></textarea>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="product-table">
                    ...
                    <tbody id="add-rows">
                        <?php static $index = 1; foreach($order_items as $i): ?>
                            <tr>
                                <td>
