...
<section class="content">
    <div class="card">
        <div class="card-header py-2">
            ...
            <a href="<?php isset($customer) ? url_to('customer.quotation.list', $customer->id) : url_to('quotation.list'); ?>" class="btn btn-info float-right">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            class="form-control" 
                            id="quotation_number" 
                            value="<?= set_value('quotation_number'); ?>"
                        />
                    </div>
                </div>
                <div class="col-md-4">
