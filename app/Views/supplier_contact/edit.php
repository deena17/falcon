...
<div class="card">
    <div class="card-header">
        ...
        <a href="<?= url_to('supplier.detail', $supplier->id); ?>" class="btn btn-info float-right">
            <i class="fa fa-arrow-left mr-2"></i>Back
        </a>
    </div>
    <div class="card-body">
        <form method="POST" action="<?= url_to('supplier.contact.edit', $supplier->id, $contact->id); ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" id="contact-mobile" name="contact_mobile" value="<?= $contact->contact_number; ?>"
