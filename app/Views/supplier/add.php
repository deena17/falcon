...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h5 class="card-title"><strong>New Supplier</strong></h5>
        <a href="<?= url_to('supplier.list'); ?>" class="btn btn-info float-right">
            <i class="fa fa-arrow-left mr-2"></i>Back
        </a>
    </div>
    <div class="card-body">
        <form method="POST" action="<?= url_to('supplier.add'); ?>">
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="vendor-code">Vendor Code</label>
                        <input type="text" id="vendor-code" name="vendor_code" value="<?= set_value('vendor-code'); ?>"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= set_value('contact_name'); ?>" id="office-number"
                                name="office_number"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= set_value('fax_number'); ?>"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="country" id="country" class="form-control" value="<?= set_value('country'); ?>" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
